--	FacebookLondon / StatingFiltered / FacebookFiltered and FacebookFiltered
...
SELECT d.database_id, d.name, d.recovery_model_desc INTO #Dbs2Consider FROM sys.databases as d
	...
	AND d.name IN ('FaceBook', 'MusicDK', 'Twitter', 'YouTubeAudioVideo')--,'YouTubeFiltered','FacebookLondon','FacebookFiltered','FacebookFiltered')
