---------------------------------------------------------------------
-- Script that creates the sample database PerformanceV5
--
...
SET NOCOUNT ON;
USE master;
IF DB_ID(N'PerformanceV5') IS NULL CREATE DATABASE PerformanceV5;
GO
USE PerformanceV5;
GO
...
IF OBJECT_ID(N'dbo.Nums'   , N'U') IS NOT NULL DROP TABLE dbo.Nums;
