...
ALTER PROCEDURE [dbo].[usp_GetLogWalkJobHistoryAlert_Suppress] 
		...
		@p_SlackMailID VARCHAR(1000) = 'kSDFS1w9g1k7d5e0@contso.slack.com;DBA@contso.com;',
		@p_Help BIT = 0
AS
BEGIN 
	/*
...
declare cur_jobs cursor forward_only local read_only for 
		SELECT j.name
				,'EXEC DBA..[usp_GetLogWalkJobHistoryAlert_Suppress] @p_JobName = '''+j.name+''', @p_NoOfContinousFailuresThreshold = 2
													,@p_SendMail = 1 
													,@p_Mail_TO = ''DBA@contso.com; App-Team@contso.com''
													--,@p_Mail_TO = ''ajay.dwivedi@contso.com;anant.dwivedi@contso.com''
													,@p_Mail_CC = ''firstname.lastname@contso.com;''
